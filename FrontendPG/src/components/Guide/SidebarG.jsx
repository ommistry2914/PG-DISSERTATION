    ...
    <div className='sidebar_guide'>
                <a onClick={togglegMenu}>&#9776;</a>
                    {gMenuVisible && <ul className="guide_nav">
                        ...
                        <li><Link to='/mentorprofile/pastStudents'>
                    ...
                    {!gMenuVisible && <ul className='guide_nav'>
                                ...
                                <li><Link to='/mentorprofile/pastStudents'><img width="20" height="20" title='Student Mentored' src="https://img.icons8.com/ios-glyphs/30/graduation-cap--v1.png" alt="graduation-cap--v1" />
                                </Link></li>
                                <li><Link to='/mentorprofile/request'>
