    ...
    <div className='common-pg-contents'>
      ...
      <div className="container common-pg-progress-section row">
        ...
        <div className="common-pg-progress-circles row col-sm-12 container">
          <div className='common-pg-progress-ring col-sm-4'><CircularProgressBar percentage={progress.credentialsProgress} />CR Progress</div>
          <div className='common-pg-progress-ring col-sm-4'><CircularProgressBar percentage={progress.pending} />Pending Tasks</div>
          <div className='common-pg-progress-ring col-sm-4'><CircularProgressBar percentage={progress.completed} />Completed Tasks</div>
        </div>
